      ...
      <main className="grid grid-cols-3 ">
        <div className="row-start-1">
          <svg
            ...
            transform="rotate(-15) translate(-100,-200)"
            fill="#1c0a26"
            fillOpacity="1"
            fillRule="nonzero"
        ...
        <div className="row-start-1 p-4 ml-16 mt-80 absolute">
          ...
          <div class="indexp">
            ...
            <div
              class="indexbut"
              className="flex flex-row gap-12 p-2 pl-6 text-xxl font-large font-IBMPlexSans font-semibold"
            >
              <Link href="/search">
                <a className="px-10 py-4 bg-[#5B21B6] rounded-md col-span-2 button1">
                  Search
                </a>
              </Link>
              <Link href="/submitfeedback">
                <a className="px-10 py-4 bg-[#5B21B6] rounded-md col-span-3">
                  Get Feedback
                </a>
              </Link>
            </div>

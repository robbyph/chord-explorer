        ...
        <div>
            ...
            <div className=''>
                <svg
                    ...
                    className="absolute transform shadow-2xl -rotate-[20deg] xl:-translate-x-36 xl:-translate-y-28"
                >
                    <defs id="defs13">
                        <clipPath clipPathUnits="userSpaceOnUse" id="clipPath25">
                            <path d="M 0,792 H 1224 V 0 H 0 Z" id="path23" className='pointer-events-none' />
                        </clipPath>
                    </defs>

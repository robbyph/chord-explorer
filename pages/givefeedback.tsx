          ...
          {posts &&
            posts.docs.map((p) => {
              return (
                <li
                  key={p.id}
                  className="flex flex-row p-4 m-4 ml-6 text-black bg-white"
                >
                  <div>
                    <h2 className="text-2xl font-medium font-HindSiliguri">
                      {p.data().title}
                    </h2>
                    ...
                    <br />
                    <p className="w-3/4 font-IBMPlexSans">
                      {p.data().description}
                    </p>
                    <br />
                    <button className="rounded-lg font-medium font-IBMPlexSans p-2 mt-2 text-lg text-white bg-[#5B21B6]">
                      <Link className="-m-2" href={`/post/${p.id}`}>
                        Give Feedback
                      </Link>
                    </button>
                  </div>
